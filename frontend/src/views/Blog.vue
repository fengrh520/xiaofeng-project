<template>
  <div class="blog-container">
    <div class="blog-header">
      <el-button @click="$router.push('/')" icon="Back" circle class="back-btn" />
      <h1>🚀 从零打造 AI 提示词优化助手：Vue3 + Django 全栈开发实战复盘</h1>
      <div class="blog-meta">
        <span>📅 2024-03-20</span>
        <el-tag size="small" effect="plain">Vue 3</el-tag>
        <el-tag size="small" effect="plain">Django 5</el-tag>
        <el-tag size="small" effect="plain">实战复盘</el-tag>
      </div>
    </div>
    ...
    <div class="blog-footer">
      <div class="cta-box">
        <h3>🎉 觉得有意思？快来亲自体验一下！</h3>
        <p>让 AI 帮你把“大白话”变成“专家级指令”，效率提升 10 倍。</p>
        <el-button type="primary" size="large" @click="$router.push('/')" round>
          立即试用小封机器人 🚀
        </el-button>
      </div>
      <p class="copyright">感谢阅读！如果觉得有帮助，欢迎分享给更多朋友。</p>
    </div>
  </div>
</template>
...
// 渲染 Markdown
const renderedContent = marked(markdownText)
</script>
